function [y2] = ButterLPFn2(wc,Ts,u2,y0,y1)
%PURPOSE
%This function filters input data. A low pass 2nd order Butterworth filter
%is used with backward time method for real time filtering.
...
% opposed to vectors, are passed into this function, i.e. data points are
% streamed as they are collected.
